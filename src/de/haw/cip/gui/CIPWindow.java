...
public class CIPWindow extends JDefaultFrame {
	...
	public String getSelectedSource() {
		...
		switch(index) {
			case 0 : return this._scannerOutput.getText();
			case 1 : return this._symbolOutput.getText();
			case 2 : return this._ptfOutput.getText();
			case 3 : return this._asmOutput.getText();
			default: return "";
		}
	}
